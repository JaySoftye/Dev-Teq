...
<!DOCTYPE html>
 <html>
   <head>
     ...
     <script src="../consulting-services/public/js/app.js"></script>
   </head>
 ...
 <body>
   ...
   <nav id="mainNav">
     <div class="mobileNav hide-large">
       <ul class="nav">
         <li class="nav-item">
           <a href="#navbarMobile" data-toggle="collapse" aria-expanded="false" aria-controls="classroomConceptsMenu" aria-label="Toggle navigation" title="menue"><img src="../consulting-services/public/images/mobilenav-logo-icon.svg" class="mainLogo" /></a>
         </li>
       </ul>
       <ul id="navbarMobile" class="fade collapse">
         <li class="nav-item">
           ...
           <ul class="footerLinks subnav collapse" id="mobileMenuProducts">
             <li><a href="../pd-platforms/" class="white">PD Platforms</a></li>
             <li><a href="../instructional-software/" class="white">Instructional Software</a></li>
             <li><a href="../stem/" class="white">STEM Solutions</a></li>
             <li><a href="../sight-and-sound/" class="white">Sight and Sound</a></li>
             <li><a href="../sd-wan/" class="white">Software Assurance</a></li>
           </ul>
         </li>
         <li class="nav-item">
         ...
         <li class="nav-item">
           ...
           <ul class="footerLinks subnav collapse" id="mobileMenuConcepts">
             <li><a href="../elementary-classroom-concepts/mobile/" class="white">Elementary and Early Childhood</a></li>
             <li><a href="../middle-classroom-concepts/mobile/" class="white">Middle</a></li>
             <li><a href="../high-classroom-concepts/mobile/" class="white">High</a></li>
             <li><a href="../special-education-classroom-concepts/mobile/" class="white">Special Ed / Inclusion Classroom</a></li>
           </ul>
         </li>
         <li class="nav-item">
           ...
           <ul class="footerLinks subnav collapse" id="mobileMenuServices">
             <li><a href="../support-and-services/" class="white">Service and Bundles</a></li>
             <li><a href="../support-and-services/support-resources/" class="white">Projector Guides</a></li>
           </ul>
         </li>
         <li class="nav-item">
           ...
           <ul class="footerLinks subnav collapse" id="mobileMenuLearning">
             ...
             <li><a href="../learning-community/datasheet-downloads/" class="white">Downloads</a></li>
           </ul>
         </li>
         <li class="nav-item">
           <h6><a class="white nav-link" href="../teq-events/">Teq Events</a></h6>
         </li>
         <li class="nav-item">
           ...
           <ul class="footerLinks subnav collapse" id="mobileMenuAbout">
             <li><a href="../about-us/" class="white">About Teq</a></li>
             <li><a href="../about-us/testimonials/" class="white">Testimonials</a></li>
             <li><a href="../about-us/teq-careers/" class="white">Careers at Teq</a></li>
     ...
     <div id="navMain" class="container-fluid hide-small">
       <ul class="nav">
         <li class="nav-item">
           <a href="http://www.teq.com/"><img src="../consulting-services/public/images/teq-logo-icon.svg" class="mainLogo" /></a>
         </li>
         <li class="nav-item">
         ...
         <li class="nav-item">
           <a class="nav-link" href="../teq-events/">Events</a>
         </li>
         <li class="nav-item">
     ...
     <div class="collapse fade subnav" id="productsMenu">
       <div class="container-fluid">
         <ul class="nav row">
           <li class="col-sm">
             <h5><a class="subnav-link" href="../pd-platforms">PD Platforms</a></h5>
             <ul>
               <li><a href="../pd-platforms/onsite-pd" class="subnav-link">Onsite PD</a></li>
               <li><a href="../pd-platforms/online-pd" class="subnav-link">Online PD</a></li>
               <li><a href="../pd-platforms/now-instructional-support/" class="subnav-link">nOw Instructional Support</a></li>
               <li><a href="../pd-platforms/teq-essentials" class="subnav-link">Teq Essentials</a></li>
               <li><a href="../pd-platforms/teacher-certifications/" class="subnav-link">Teq Digital Teacher Certifications</a></li>
             </ul>
           </li>
           <li class="col-sm">
             <h5><a class="subnav-link" href="../instructional-software/">Instructional Software</a></h5>
             <ul>
               <li><a href="../instructional-software/smart-learning-suite" class="subnav-link">SMART Learning Suite</a></li>
               <li><a href="../instructional-software/stemfuse/" class="subnav-link">STEM Fuse</a></li>
               <li><a href="../pd-platforms/teq-essentials" class="subnav-link">Teq Essentials</a></li>
             </ul>
           </li>
           <li class="col-sm">
           ...
           <li class="col-sm">
             ...
             <ul>
               ...
               <li><a href="../sight-and-sound/audio-enhancement/" class="subnav-link">Audio Enhancement</a></li>
               <li><a href="../sight-and-sound/safe-system/" class="subnav-link">SAFE System</a></li>
               <li><a href="../sight-and-sound/wall-mounts-mobile-stands/" class="subnav-link">Wall Mounts/Mobile Stands</a></li>
               <li><a href="../sight-and-sound/tech-tub/" class="subnav-link">Tech Tub</a></li>
               <li><a href="../sight-and-sound/accessories/" class="subnav-link">Accessories</a></li>
             </ul>
           </li>
           <li class="col-sm">
             <h5 class="white"><a class="subnav-link" href="../sd-wan/">SD-WAN from Cloudgenix</a></h5>
             <ul>
               <li><a href="../sd-wan/cloudgenix-roi/" class="subnav-link">Return on Investment</a></li>
               <li><a href="../sd-wan/cloudgenix-central-control-point/" class="subnav-link">Centralized Control Center</a></li>
               <li><a href="../sd-wan/cloudgenix-software-assurance/" class="subnav-link">Software Assurance</a></li>
             </ul>
           </li>
     ...
     <div class="collapse fade subnav" id="classroomConceptsMenu">
       <div class="container">
         <ul class="nav row">
           <li class="col-sm"><a class="nav-link subnav-link" href="../elementary-classroom-concepts/">Elementary &amp; Early Childhood Concepts</a></li>
           <li class="col-sm"><a class="nav-link subnav-link" href="../middle-classroom-concepts/">Middle School Concepts</a></li>
           <li class="col-sm"><a class="nav-link subnav-link" href="../high-classroom-concepts/">High School Concepts</a></li>
           <li class="col-sm"><a class="nav-link subnav-link" href="../special-education-classroom-concepts/">Special Ed / Inclusion Classroom Concepts</a></li>
           <li class="nav-item col-sm closeMenuCell"><a href="#classroomConceptsMenu" data-toggle="collapse" aria-expanded="false" aria-controls="classroomConceptsMenu"><img class="closeLogo" src="../consulting-services/public/images/subnav-collapse-icon.svg" /></a></li>
         </ul>
       </div>
     </div>
     <div class="collapse fade subnav" id="supportMenu">
       <div class="container">
         <ul class="nav row">
           <li class="col-sm"><a class="nav-link subnav-link" href="../support-and-services/">Service Plans</a></li>
           <li class="col-sm"><a class="nav-link subnav-link" href="../support-and-services/support-resources/">Product Guides</a></li>
           <li class="col-sm"><a class="nav-link subnav-link" href="../support-and-services/#contactSupportTeam">Contact Support</a></li>
           <li class="col-sm"><a class="nav-link subnav-link" href="../support-and-services/teqsquad/">Teq Squad</a></li>
     ...
     <div class="collapse fade subnav" id="learningMenu">
       <div class="container">
         <ul class="nav row">
           <li class="col-sm"><a class="nav-link subnav-link" href="/learning-community/teq-talk/">Teq Talk</a></li>
           <li class="col-sm"><a class="nav-link subnav-link" href="/learning-community/teq-tips/">Teq Tips</a></li>
           <li class="col-sm"><a class="nav-link subnav-link" href="../learning-community/datasheet-downloads/">Downloads</a></li>
           <li class="col-sm"><a class="nav-link subnav-link" href="/learning-community/media-resource-center/">Media Center</a></li>
           <li class="col-sm"><a class="nav-link subnav-link" href="/learning-community/social-media-center/">Social Media</a></li>
           <li class="nav-item closeMenuCell"><a href="#learningMenu" data-toggle="collapse" aria-expanded="false" aria-controls="learningMenu"><img class="closeLogo" src="../consulting-services/public/images/subnav-collapse-icon.svg" /></a></li>
         </ul>
       </div>
     </div>
     <div class="collapse fade subnav" id="aboutMenu">
       <div class="container">
         <ul class="nav row">
           ...
           <li class="col-sm"><a class="nav-link subnav-link" href="../contact-us/">Contact Us</a></li>
           <li class="nav-item col-sm closeMenuCell"><a href="#aboutMenu" data-toggle="collapse" aria-expanded="false" aria-controls="aboutMenu"><img class="closeLogo" src="../consulting-services/public/images/subnav-collapse-icon.svg" /></a></li>
         </ul>
       </div>
     </div>
     <div class="collapse fade subnav" id="freeOffer">
       <div class="container">
         <div class="row">
           ...
           <div class="col-md-6">
             <a href="http://onlinepd.teq.com/gettingstarted/" onclick="trackOutboundLink('http://onlinepd.teq.com/gettingstarted/'); return false;"><img src="../consulting-services/public/images/teq-headernav-GettingStartedAd.png" class="full" /></a>
           </div>
           <div class="col-md-3">
           ...
           <div class="col-md-1">
             <a href="#freeOffer" data-toggle="collapse" aria-expanded="false" aria-controls="freeOffer"><img class="closeLogo" src="../consulting-services/public/images/subnav-collapse-icon.svg" /></a>
           </div>
         </div>
       </div>
     </div>
