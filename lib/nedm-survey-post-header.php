     ...
     <nav id="mainNav">
       ...
       <div class="mobileNav hidden-lg-up hidden-md-up">
         ...
         <ul id="navbarMobile" class="nav collapse">
           ...
           <li class="nav-item">
             <h6><a class="white nav-link" data-toggle="collapse" href="#mobileMenuServices" aria-expanded="false" aria-controls="mobileMenuServices">Technical Support</a></h6>
       ...
       <div id="navMain" class="container-fluid collapse navbar-toggleable-sm">
         <ul class="nav navbar-nav">
           ...
           <li class="nav-item">
               <a class="nav-link" href="#supportMenu" data-toggle="collapse" aria-expanded="false" aria-controls="supportMenu">Technical Support</a>
           </li>
           <li class="nav-item">
         ...
         <div class="container-fluid">
           <ul class="nav row">
             <li class="col-sm">
                 ...
                 <ul class="nav">
                   <li><a href="<?php echo site_url(); ?>/pd-platforms/eils/" class="subnav-link"><strong>Effective Instructional Leadership & Supervision</strong></a></li>
             ...
             <li class="col-sm">
                 ...
                 <ul class="nav">
                   <li><a href="<?php echo site_url(); ?>/stem/si/" class="subnav-link"><strong>STEM Initiatives</strong></a></li>
