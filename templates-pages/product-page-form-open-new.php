<?php
/**
 * Template Name: NEW Product Page with Form Open and More Info Button
 *
 * @package WordPress
...
?>
  <?php get_header(); ?>
    ...
    ?>
      ...
      <div class="container-fluid nopadding trialForm trialFormOpen new-product-form collapse in" id="trialsignup">
