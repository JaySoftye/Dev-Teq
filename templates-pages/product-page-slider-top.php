<?php
/**
 * Template Name: Product Page with a Top Slider
 *
 * @package WordPress
        ...
        <div id="product-carousel" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item active">
              <img src="<?php echo get_template_directory_uri(); ?>/images/<?php echo get_post_meta($postid, 'sliderOneImage', true); ?>.jpg" alt="First slide">
              <div class="carousel-caption">
                <h3><?php echo get_post_meta($postid, 'sliderOneTitle', true); ?></h3>
                <p><?php echo get_post_meta($postid, 'sliderOneCaption', true); ?></p>
              </div>
            </div>
            <?php if(metadata_exists( 'post', $post->ID,'sliderTwoImage')) { ?>
            <div class="carousel-item">
              <img src="<?php echo get_template_directory_uri(); ?>/images/<?php echo get_post_meta($postid, 'sliderTwoImage', true); ?>.jpg" alt="First slide">

              <div class="carousel-caption">
                <h3><?php echo get_post_meta($postid, 'sliderTwoTitle', true); ?></h3>
                <p><?php echo get_post_meta($postid, 'sliderTwoCaption', true); ?></p>
              </div>
            </div>
            <?php }
              if(metadata_exists( 'post', $post->ID,'sliderThreeImage')) { ?>
            <div class="carousel-item">
              <img src="<?php echo get_template_directory_uri(); ?>/images/<?php echo get_post_meta($postid, 'sliderThreeImage', true); ?>.jpg" alt="First slide">
              <div class="carousel-caption">
                <h3><?php echo get_post_meta($postid, 'sliderThreeTitle', true); ?></h3>
                <p><?php echo get_post_meta($postid, 'sliderThreeCaption', true); ?></p>
              </div>
            </div>
            <?php } ?>
          </div>
