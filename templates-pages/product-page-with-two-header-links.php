<?php
/**
 * Template Name: Product Page with 2 header links
 *
 * @package WordPress
        ...
        <div class="row height-full bottomGradient">
          <div class="container flex-md-bottom">
            ...
            <center>
              ...
              <a href="<?php echo get_post_meta($postid, 'secondHeaderLinkURL', true); ?>"><button class="d-inline-block light" style="margin-left: 10px;" type="button"><?php echo get_post_meta($postid, 'secondHeaderLink', true); ?></button></a>
            </center>
          </div>
        </div>
      </div>
