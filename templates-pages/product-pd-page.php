        ...
        <div class="carousel-item active essentialsBackground1">
          ...
          <div class="container padding-top padding-bottom">
            <div class="col-md-6 nopadding">
              ...
              <h3 class="white">Combine the learning power of <a class="white bold" href="<?php echo site_url(); ?>/pd-platforms/online-pd"/>Online</a> and <a class="white bold" href="<?php echo site_url(); ?>/pd-platforms/onsite-pd">Onsite PD</a> with an unparalleled level of Instructional Support for your Essential Learning Package.</h3><a class="white" href="http://onlinepd.teq.com">onlinepd.teq.com</a>
